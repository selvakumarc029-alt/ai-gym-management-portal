...
public class ApiController {
    ...
    public ResponseEntity<String> qr(@RequestParam String memberId, HttpServletRequest request) throws Exception {
        ...
        String target = base + "/attendance?memberId=" + memberId;
